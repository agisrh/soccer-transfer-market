...
import 'package:transfer_market/ui/statistic_screen.dart';
import '../core/controller/feature_controller.dart';

class StatisticsTab extends StatelessWidget with WidgetsBindingObserver {
      ...
      child: GetBuilder(
        ...
        initState: (state) {
          WidgetsBinding.instance.addPostFrameCallback((_) async {
            await MyController.homeController.getTable(leagueId: clubs[0].id);
          });
        },
...
class _HomeTabBarState extends State<HomeTabBar> {
  ...
  Widget build(BuildContext context) {
    ...
    tabController.addListener(() {
      setState(() {
        widget.controller.indexTabStat = tabController.index;
